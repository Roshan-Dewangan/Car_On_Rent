...
import { motion } from "framer-motion"; // changed to framer-motion, since motion/react is incorrect
      ...
      >
        {menuLinks.map((link, index) => (
          <Link
            ...
            onClick={() => setOpen(false)} // close menu on click link (mobile)
          >
            {link.name}
          </Link>
        ))}
        ...
        <div className="flex max-sm:flex-col items-start sm:items-center gap-6">
          <button
            ...
            className="cursor-pointer text-sm font-medium hover:text-primary transition"
          >
