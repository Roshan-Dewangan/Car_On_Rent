...
const Testimonials = () => {
    ...
    const testimonials = [
        ...
        {  name: "John Smith", 
           ...
           testimonial: "CarRental made my trip so much easier. The car was delivered right on door, and the customer service was fantastic!." 
        },

        {  name: "Ava Johnsmith", 
           location: "Sydney, Austrelia", 
           image: assets.testimonial_image_1,
  ...
  return (
    <div className="py-28 px-6 md:px-16 lg:px-24 xl:px-44">
            ...
            <Title title= "What Our Customers Say" subTitle="Dicsover why discerning travelers choose StayVenture for their luxury accomodations around the world." />
