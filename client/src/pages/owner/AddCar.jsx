        ...
        <div className="flex items-center gap-2 w-full">
          <label htmlFor="car-image">
            ...
            <img
              ...
              alt=""
              className="A-14 rounded cursor-pointer"
            />
            <input
              type="file"
              id="car-image"
...
rounded-md outline-none"
            >
              {" "}
              I<option value="">Select a category</option>
...
rounded-md outline-none"
        ...
        <div className="flex flex-col w-full">
          ...
          <textarea
            rows={5}
            placeholder="e.g. A luxurious SUV with a spacious

interior and a powerful engine."
            required
            className="px-3 py-2 mt-1
