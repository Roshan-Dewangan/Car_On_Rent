  ...
  return (
    <div className="px-4 pt-10 md:px-10 w-full">
      <Title
        ...
        subTitle="Track all customer bookings, approve or cancel requests, and manage booking statuses all listed cars, update their details, or remove them from the booking platform."
      />
