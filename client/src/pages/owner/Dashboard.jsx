...
rounded-md border border-borderColor"
          >
            ...
            <div
              className="flex items-center justify-center w-10 h-10 rounded-full I
      ...
      <div>
        ...
        <div className="p-4 md:p-6 border border-borderColor rounded-md max-w-lg w-full">
          ...
          {data.recentBookings.map((booking, index) => (
            <div key={index} className="mt-4 flex items-center justify-betweem">
              <div className="flex items-center gap-2">
                <div
                  className="hidden md:flex items-center justify-center w
